#include<radiation_costmap_layer_plugin/grid_layer.h>
                                           ...
                                           double* min_y, double* max_x, double* max_y)
{
  ...
  //if(worldToMap(mark_x, mark_y, mx, my)){
    //printf("worldtomap %d %d %d %d", mark_x, mark_y, mx, my);
    //setCost(mx, my, LETHAL_OBSTACLE);
  //}
  worldToMapNoBounds(mark_x, mark_y, mx, my);
  setCost((unsigned int) mx, (unsigned int) my, LETHAL_OBSTACLE);
